...
static Configure buildConfigureFromOptions(const OptT &Opt) noexcept {
  Configure Conf;
...
int Tool(struct DriverToolOptions &Opt) noexcept {
  ...
  Configure Conf = buildConfigureFromOptions(Opt);
...
int Parse(struct DriverParseOptions &Opt) noexcept {
  std::ios::sync_with_stdio(false);
  Log::setInfoLoggingLevel();
  ...
  spdlog::info("WASM module parsed successfully");
  return EXIT_SUCCESS;
}

int Validate(struct DriverValidateOptions &Opt) noexcept {
  std::ios::sync_with_stdio(false);
  Log::setInfoLoggingLevel();
  ...
  spdlog::info("WASM module validated successfully");
  return EXIT_SUCCESS;
}

int Instantiate(struct DriverInstantiateOptions &Opt) noexcept {
  std::ios::sync_with_stdio(false);
  Log::setInfoLoggingLevel();
  ...
  spdlog::info("WASM module instantiated successfully");
  return EXIT_SUCCESS;
}
